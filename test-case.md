...
| :--- | :--- | :--- | :---: |
| **TC.C1** | Kiểm tra Responsive Trang chủ | Hiển thị Banner Hero, Features và Sản phẩm Trending mượt mà trên Mobile/Tablet. | [ ] |
| **TC.C2** | Chuyển đổi Ngôn ngữ (Switch VN/EN) | Sau khi click đổi tiếng, Header, Footer và TOÀN BỘ GIÁ SẢN PHẨM phải cập nhật đúng ngôn ngữ/tỉ giá. | [ ] |
...
| **TC.C5** | Checkout & Khuyến mãi | Giá cũ gạch ngang, giá mới hiển thị rõ. Phí ship miễn phí nếu đơn hàng trên 3.750.000đ. | [ ] |
| **TC.C6** | Theo dõi đơn hàng (Tracking) | Nhập mã đơn hàng và xem được trạng thái (PENDING -> SHIPPING -> ...) real-time. | [ ] |
...
| **TC.A4** | Import/Export Excel | Tải được file Excel mẫu về máy. Import File sản phẩm không bị lỗi định dạng. | [ ] |
| **TC.A5** | Marketing Dashboard | Quản lý các chiến dịch (Active/Expired). Các chiến dịch cũ vẫn được lưu trữ để xem báo cáo. | [ ] |
...
---
🔍 *Tài liệu kiểm định được thiết lập bởi Antigravity vào ngày 23/03/2026.*
